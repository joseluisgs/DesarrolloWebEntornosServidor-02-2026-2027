...
- [30.1. ¿Qué es CQRS?](#301-qué-es-cqrs)
  ...
  - [30.1.3. ¿Por qué separar escrituras y lecturas?](#3013-por-qué-separar-escrituras-y-lecturas)
    - [El coste de las claves foráneas y los JOINs](#el-coste-de-las-claves-foráneas-y-los-joins)
    - [El coste de tener dos bases de datos](#el-coste-de-tener-dos-bases-de-datos)
    - [¿Cuándo merece la pena?](#cuándo-merece-la-pena)
...
- [30.8. Kafka: la opción profesional](#308-kafka-la-opción-profesional)
  ...
  - [30.8.3. Flujo completo: PostgreSQL → Kafka → MongoDB](#3083-flujo-completo-postgresql--kafka--mongodb)
